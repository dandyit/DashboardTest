        ...
        <div className='popup' id='popup'>
            <div className='popup__content'>
                ...
                <div className='popup__right'>
                    ...
                    <h5 className='heading-5 text-upper u-margin-bottom-medium'> Your all event revenues</h5>

                    <div className='form__group u-margin-bottom-medium'>
                        <div className='form__box'>
                            <select className="form__select form__select__size-2">
                                <option>Event Name</option>
                                <option>event 1 revenues</option>
                                <option>event 2 revenues</option>
                                <option>event 3 revenues</option>
                                <option>event 4 revenues</option>
                            </select>
                        </div>
                    </div>
                    <a href='/Revenue' className='btn btn--blue'>Done</a>
                </div>
            </div>
        </div>
    )
